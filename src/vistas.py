...
class VistaCausa ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Causa", pos = wx.DefaultPosition, size = wx.Size( 718,463 ), style = wx.DEFAULT_FRAME_STYLE|wx.MAXIMIZE_BOX|wx.RESIZE_BORDER|wx.TAB_TRAVERSAL )
		...
		self.paCausa = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 150,-1 ), wx.TAB_TRAVERSAL )
		...
		clEscritosChoices = []
		self.clEscritos = wx.CheckListBox( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, clEscritosChoices, 0 )
		...
		self.paObjeto = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
...
class PanelCausa ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 224,514 ), style = wx.TAB_TRAVERSAL )
		
		bSizer5 = wx.BoxSizer( wx.VERTICAL )
		
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, u"Expediente Judicial", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText3.Wrap( -1 )
		
		bSizer5.Add( self.m_staticText3, 0, wx.ALL, 5 )
		
		self.tcExpteJud = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer5.Add( self.tcExpteJud, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, u"Expediente Policial", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4.Wrap( -1 )
		
		bSizer5.Add( self.m_staticText4, 0, wx.ALL, 5 )
		
		self.tcExptePol = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer5.Add( self.tcExptePol, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText5 = wx.StaticText( self, wx.ID_ANY, u"Expediente Otro", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText5.Wrap( -1 )
		
		bSizer5.Add( self.m_staticText5, 0, wx.ALL, 5 )
		
		self.tcExpteOtro = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer5.Add( self.tcExpteOtro, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText6 = wx.StaticText( self, wx.ID_ANY, u"Carátula", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText6.Wrap( -1 )
		
		bSizer5.Add( self.m_staticText6, 0, wx.ALL, 5 )
		
		self.tcCaratula = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
		bSizer5.Add( self.tcCaratula, 1, wx.ALL|wx.EXPAND, 5 )
		
		bSizer7 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText7 = wx.StaticText( self, wx.ID_ANY, u"Estado", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText7.Wrap( -1 )
		
		bSizer7.Add( self.m_staticText7, 0, wx.ALL, 5 )
		
		self.lblEstado = wx.StaticText( self, wx.ID_ANY, u"...", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		chEstadoChoices = []
		self.chEstado = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, chEstadoChoices, 0 )
		self.chEstado.SetSelection( 0 )
		bSizer5.Add( self.chEstado, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText8 = wx.StaticText( self, wx.ID_ANY, u"Observaciones", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText8.Wrap( -1 )
		
		bSizer5.Add( self.m_staticText8, 0, wx.ALL, 5 )
		
		self.tcObservaciones = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
		bSizer5.Add( self.tcObservaciones, 1, wx.ALL|wx.EXPAND, 5 )
		
		bSizer8 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText9 = wx.StaticText( self, wx.ID_ANY, u"Destinatario", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText9.Wrap( -1 )
		
		bSizer8.Add( self.m_staticText9, 0, wx.ALL, 5 )
		
		self.lblDestinatario = wx.StaticText( self, wx.ID_ANY, u"...", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.chDestinatario = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, chDestinatarioChoices, 0 )
...
class OficinasJudiciales ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 777,471 ), style = wx.DEFAULT_DIALOG_STYLE|wx.MAXIMIZE_BOX|wx.RESIZE_BORDER )
		...
		self.lsOficinas = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_REPORT|wx.LC_SORT_ASCENDING )
		...
		self.m_staticText331 = wx.StaticText( self, wx.ID_ANY, u"Identificador", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText331.Wrap( -1 )
		
		fgSizer5.Add( self.m_staticText331, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.tcId = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer5.Add( self.tcId, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText26 = wx.StaticText( self, wx.ID_ANY, u"Nombre", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText26.Wrap( -1 )
		
		fgSizer5.Add( self.m_staticText26, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		self.tcNombre = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer5.Add( self.tcNombre, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText28 = wx.StaticText( self, wx.ID_ANY, u"Circunscripción", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText28.Wrap( -1 )
		
		fgSizer5.Add( self.m_staticText28, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		self.tcCircunscripcion = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 10, 0 )
		fgSizer5.Add( self.tcCircunscripcion, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText29 = wx.StaticText( self, wx.ID_ANY, u"Autoridad", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText29.Wrap( -1 )
		
		fgSizer5.Add( self.m_staticText29, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.tcACargo = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText31 = wx.StaticText( self, wx.ID_ANY, u"Tipo", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText31.Wrap( -1 )
		
		bSizer34.Add( self.m_staticText31, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.AddTipoOficina = wx.StaticText( self, wx.ID_ANY, u"...", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		chIdTipoChoices = []
		self.chIdTipo = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, chIdTipoChoices, 0 )
		self.chIdTipo.SetSelection( 0 )
		fgSizer5.Add( self.chIdTipo, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText33 = wx.StaticText( self, wx.ID_ANY, u"EMail", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText33.Wrap( -1 )
		
		fgSizer5.Add( self.m_staticText33, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.tcCorreoElectronico = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer5.Add( self.tcCorreoElectronico, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText34 = wx.StaticText( self, wx.ID_ANY, u"Teléfono", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText34.Wrap( -1 )
		
		fgSizer5.Add( self.m_staticText34, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.tcTelefono = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.btReestablecer = wx.Button( self, wx.ID_ANY, u"&Reestablecer", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer231.Add( self.btReestablecer, 0, wx.ALL, 5 )
		
		self.btSalir = wx.Button( self, wx.ID_ANY, u"&Guardar", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.lsOficinas.Bind( wx.EVT_LIST_ITEM_SELECTED, self.lsOficinasOnListItemSelected )
...
class PanelEscrito ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 420,498 ), style = wx.TAB_TRAVERSAL )
		...
		self.tcDescripcion = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
		...
		self.dpIngreso = wx.adv.DatePickerCtrl( self, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.adv.DP_DEFAULT|wx.adv.DP_DROPDOWN )
		...
		self.dpSalida = wx.adv.DatePickerCtrl( self, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.adv.DP_ALLOWNONE|wx.adv.DP_DEFAULT|wx.adv.DP_DROPDOWN )
...
class PanelObjeto ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 613,360 ), style = wx.TAB_TRAVERSAL )
		...
		self.m_staticText30 = wx.StaticText( self, wx.ID_ANY, u"Pertenece a:", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		self.m_staticText30.Wrap( -1 )
		
		fgSizer2.Add( self.m_staticText30, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.lblObjetoRelacionado = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0|wx.BORDER_RAISED )
		self.lblObjetoRelacionado.Wrap( -1 )
		
		fgSizer2.Add( self.lblObjetoRelacionado, 1, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText19 = wx.StaticText( self, wx.ID_ANY, u"Descripción", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		self.m_staticText19.Wrap( -1 )
		...
		self.tcUbicacionFisica = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
		fgSizer2.Add( self.tcUbicacionFisica, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText21 = wx.StaticText( self, wx.ID_ANY, u"Fotos", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		self.m_staticText21.Wrap( -1 )
...
class EdicionCausa ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.btGuardar = wx.Button( self, wx.ID_ANY, u"&Guardar", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class EdicionObjeto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Edición Objeto", pos = wx.DefaultPosition, size = wx.Size( 626,484 ), style = wx.DEFAULT_DIALOG_STYLE|wx.MAXIMIZE_BOX|wx.RESIZE_BORDER )
...
class EdicionEscrito ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Edición Escrito", pos = wx.DefaultPosition, size = wx.Size( 716,654 ), style = wx.DEFAULT_DIALOG_STYLE|wx.MAXIMIZE_BOX|wx.RESIZE_BORDER )
...
class Main ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"SIGI IF", pos = wx.DefaultPosition, size = wx.Size( 756,350 ), style = wx.DEFAULT_FRAME_STYLE|wx.MAXIMIZE|wx.TAB_TRAVERSAL )
		...
		self.mnuCausaAgregar = wx.MenuItem( self.m_menu1, wx.ID_ANY, u"Agregar", wx.EmptyString, wx.ITEM_NORMAL )
		self.m_menu1.Append( self.mnuCausaAgregar )
		
		self.menubar1.Append( self.m_menu1, u"&Causas" ) 
		
		self.m_menu6 = wx.Menu()
		self.mnuInfomeDesignar = wx.MenuItem( self.m_menu6, wx.ID_ANY, u"Designar perito", wx.EmptyString, wx.ITEM_NORMAL )
		self.m_menu6.Append( self.mnuInfomeDesignar )
		
		self.menubar1.Append( self.m_menu6, u"&Informe" ) 
		
		self.m_menu4 = wx.Menu()
		self.mnuEditarUsuario = wx.MenuItem( self.m_menu4, wx.ID_ANY, u"Editar Usuario", wx.EmptyString, wx.ITEM_NORMAL )
		self.m_menu4.Append( self.mnuEditarUsuario )
		
		self.menubar1.Append( self.m_menu4, u"Configuración" ) 
		...
		self.scBuscar = wx.SearchCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.chSelector = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, chSelectorChoices, 0 )
		self.chSelector.SetSelection( 0 )
		bSizer42.Add( self.chSelector, 0, wx.ALL, 5 )
		
		self.raTodos = wx.RadioButton( self, wx.ID_ANY, u"Todos", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.raTodos.SetValue( True ) 
		bSizer42.Add( self.raTodos, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.raExpJud = wx.RadioButton( self, wx.ID_ANY, u"ExpJud", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer42.Add( self.raExpJud, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.raExpPol = wx.RadioButton( self, wx.ID_ANY, u"ExpPol", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer42.Add( self.raExpPol, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.raExpOtros = wx.RadioButton( self, wx.ID_ANY, u"ExpOtros", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer42.Add( self.raExpOtros, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.raInforme = wx.RadioButton( self, wx.ID_ANY, u"Informe", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer42.Add( self.raInforme, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.raCaratula = wx.RadioButton( self, wx.ID_ANY, u"Caratula", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer42.Add( self.raCaratula, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		
		bSizer41.Add( bSizer42, 0, wx.EXPAND, 5 )
		
		self.lsPrincipal = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_REPORT|wx.LC_SORT_ASCENDING )
		...
		self.mnuVer = wx.MenuItem( self.mnuContext, wx.ID_ANY, u"Ver", wx.EmptyString, wx.ITEM_NORMAL )
		self.mnuContext.Append( self.mnuVer )
		
		self.mnuEditar = wx.MenuItem( self.mnuContext, wx.ID_ANY, u"Editar", wx.EmptyString, wx.ITEM_NORMAL )
		self.mnuContext.Append( self.mnuEditar )
		
		self.mnuBorrar = wx.MenuItem( self.mnuContext, wx.ID_ANY, u"Borrar", wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.Bind( wx.EVT_MENU, self.mnuCausaAgregarOnMenuSelection, id = self.mnuCausaAgregar.GetId() )
		self.Bind( wx.EVT_MENU, self.mnuEditarUsuarioOnMenuSelection, id = self.mnuEditarUsuario.GetId() )
...
class Login ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Login", pos = wx.DefaultPosition, size = wx.Size( 515,269 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.tcUsuario = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer1.Add( self.tcUsuario, 1, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, u"CONTRASEÑA", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText4.Wrap( -1 )
		
		fgSizer1.Add( self.m_staticText4, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		self.tcPass = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PASSWORD )
		fgSizer1.Add( self.tcPass, 0, wx.ALL|wx.EXPAND, 5 )
		
		
		bSizer41.Add( fgSizer1, 1, wx.EXPAND, 5 )
		...
		bSizer42.Add( self.btCancelar, 0, wx.ALL, 5 )
		
		self.btAceptar = wx.Button( self, wx.ID_ANY, u"ACEPTAR", wx.DefaultPosition, wx.DefaultSize, 0 )
		
		self.btAceptar.SetDefault()
		self.btAceptar.SetBackgroundColour( wx.Colour( 185, 255, 193 ) )
		
		bSizer42.Add( self.btAceptar, 0, wx.ALL, 5 )
		
		
		bSizer41.Add( bSizer42, 0, wx.EXPAND|wx.ALIGN_RIGHT, 5 )
...
class EdicionUsuario ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Editar usuario", pos = wx.DefaultPosition, size = wx.Size( 613,473 ), style = wx.CLOSE_BOX|wx.DEFAULT_DIALOG_STYLE|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX|wx.RESIZE_BORDER )
		...
		self.m_staticText42 = wx.StaticText( self, wx.ID_ANY, u"Usuario", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText42.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText42, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		self.tcUsuario = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer6.Add( self.tcUsuario, 1, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText47 = wx.StaticText( self, wx.ID_ANY, u"Contraseña", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText47.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText47, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		self.tcClave = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PASSWORD )
		fgSizer6.Add( self.tcClave, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText43 = wx.StaticText( self, wx.ID_ANY, u"Nombre", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText43.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText43, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		self.tcNombre = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer6.Add( self.tcNombre, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText44 = wx.StaticText( self, wx.ID_ANY, u"Presentación", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText44.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText44, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.tcPresentacion = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer6.Add( self.tcPresentacion, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText45 = wx.StaticText( self, wx.ID_ANY, u"Sello", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText45.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText45, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		self.tcSello = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
		fgSizer6.Add( self.tcSello, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText46 = wx.StaticText( self, wx.ID_ANY, u"Path", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText46.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText46, 0, wx.ALL|wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.tcDirectorio = wx.DirPickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"Elija un directorio", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		fgSizer6.Add( self.tcDirectorio, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_staticText40 = wx.StaticText( self, wx.ID_ANY, u"Grupo", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText40.Wrap( -1 )
		
		fgSizer6.Add( self.m_staticText40, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, 5 )
		
		chGrupoChoices = [ u"perito", u"administrativo" ]
		self.chGrupo = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, chGrupoChoices, 0 )
		self.chGrupo.SetSelection( 0 )
		fgSizer6.Add( self.chGrupo, 1, wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer6.Add( bSizer231, 1, wx.EXPAND, 5 )
