...
class VistaCausa ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Causa", pos = wx.DefaultPosition, size = wx.Size( 718,463 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class OficinasJudiciales ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 777,471 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
...
class PanelEscrito ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 414,308 ), style = wx.TAB_TRAVERSAL )
...
class PanelObjeto ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.dpSalida = wx.adv.DatePickerCtrl( self, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.adv.DP_DEFAULT|wx.adv.DP_DROPDOWN )
		fgSizer2.Add( self.dpSalida, 0, wx.ALL, 5 )
...
class EdicionObjeto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Edición Objeto", pos = wx.DefaultPosition, size = wx.Size( 363,346 ), style = wx.DEFAULT_DIALOG_STYLE )
